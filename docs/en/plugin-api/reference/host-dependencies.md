...
Native dependencies loaded by the Host and exposed through permissions.
...
- Kind: `interface`
- Source: [host-dependencies.ts](https://github.com/boybook/tx-5dr/blob/main/packages/plugin-api/src/host-dependencies.ts)
