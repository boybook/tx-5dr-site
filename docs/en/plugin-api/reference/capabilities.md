...
Public mapping from permissions to runtime context capabilities.
...
- Kind: `value`
- Source: [capabilities.ts](https://github.com/boybook/tx-5dr/blob/main/packages/plugin-api/src/capabilities.ts)
