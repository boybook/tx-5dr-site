...
Plugin API version comparison, minimum-version checks, and compatibility errors.
...
- Kind: `function`
- Source: [compatibility.ts](https://github.com/boybook/tx-5dr/blob/main/packages/plugin-api/src/compatibility.ts)
